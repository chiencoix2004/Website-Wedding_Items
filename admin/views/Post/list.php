            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="row layout-top-spacing">
                    ...
                    ?>
                                    <tr>
                                        <td></td>
                                        <td><a href="?act=ctbv&id=<?= $id_post ?>"><?= $id_post ?></a></td>
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="avatar  me-3">
                                                    <img src="<?= viewImageAdmin($image_Url) ?>" width="50px"
                                                        class="profile-img" alt="avatar">
                                                </div>
                                        </td>
                                        <td><span class="badge badge-danger"><?= $tittle ?></span></td>
                                        <td></td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                    <a class="dropdown-item"
                                                        href="?act=ctbv&id=<?= $id_post ?>">View</a>
                                                    <a class="dropdown-item"
                                                        href="?act=editbv&idedit=<?= $id_post ?>">Edit</a>
                                                    <a class="dropdown-item"
                                                        href="?act=delbv&iddel=<?= $id_post ?>">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
