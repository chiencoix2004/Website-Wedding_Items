                            ...
                            <div class="container mt-4 mb-3">
                                <form action="?act=upbv" method="post" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input style="color:red;" type="text" class="form-control" name="tittle"
                                            id="tittle" value="<?=$tittle?>" disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">Image</label>
                                        <br>
                                        <!-- <br> -->
                                        <img src="<?=viewImageAdmin($image_Url)?>" alt="" width="150px" height="150px">
                                        <input type="hidden" name="anhcu" value="<?=$image_Url?>">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputContent" class="form-label">Nội dung</label>
                                        <textarea disabled name="content" id="contentx" cols="30"
