...
<div class="main-container " id="container">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-8">
                            <div class="container mt-3 mb-3">
                                <form action="?act=addbv" method="post" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="content" id="contentx" cols="30" rows="10" required></textarea>
                                    </div>

                                    <div class="col-12">
                                        <!-- <button type="submit" class="btn btn-primary">Sign in</button> -->
                                        <input type="submit" class="btn btn-primary" name="themmoi" value="Create">
                                    </div>
                                </form>
                            </div>
    ...
    <form action="?act=addbv" method="post" class="row g-3" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <label for="inputfile" class="form-label">Ảnh đại diện</label>
            <input type="file" name="image" class="form-control" id="inputfile">
        </div>
        <div class="col-12">
            <label for="inputContent" class="form-label">Nội dung</label>
            <textarea name="content" id="contentx" cols="30" rows="10"></textarea>
        </div>
