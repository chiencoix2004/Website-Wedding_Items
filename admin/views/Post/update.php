...
<div class="main-container " id="container">
    ...
    <div id="content" class="main-content">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-8">
                            <div class="container mt-3 mb-3">
                                <form action="?act=upbv" method="post" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div style="border: 2px solid gray;border-radius: 10px;">
                                            <img src="<?=viewImageAdmin($image_Url)?>" alt="" width="150px"
                                                height="150px">
                                            <input type="hidden" name="anhcu" value="<?=$image_Url?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputfile" class="form-label">New Image</label>
                                        <input type="file" name="image" class="form-control" id="inputfile">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputContent" class="form-label">Content</label>
                                        <textarea name="content" id="contentx" cols="30"
                                            rows="10"><?=$content?></textarea>
                                    </div>

                                    <div class="col-12">
                                        <!-- <button type="submit" class="btn btn-primary">Sign in</button> -->
                                        <input type="submit" class="btn btn-primary" name="capnhat" value="Update">
                                    </div>
                                </form>
                            </div>
        ...
        <script>
        ClassicEditor
            .create(document.querySelector('#contentx'))
            .catch(error => {
                console.error(error);
            });
        </script>
