                            ...
                            <table id="ecommerce-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Address</th>
                                        <th>PhoneNumber</th>
                                        <th class="no-content text-center">Email</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <?php foreach($accoutList as $accout):?>

                                        <td></td>
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="d-flex flex-column">
                                                    <span class="text-truncate fw-bold"><?=$accout['username']?>(<?=$accout['role']?>)</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?=$accout['password']?></td>
                                        <td><?=$accout['address']?></td>
                                        <td><span class="badge badge-danger"><?=$accout['phone_number']?></span></td>
                                        <td class="text-center"> <?=$accout['email']?></td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
