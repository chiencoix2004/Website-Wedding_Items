                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-8">
                            <div class="import">
                                ...
                                <form method="post" action="?act=export">
                                    <input class="btn btn-primary" name="export" type="submit" value="Export">
                                </form>
                            </div>
                            <table id="ecommerce-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach($productAll as $item ):
                                        extract($item);
                                        $img =  getSanPhamAnhOne($id_product);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="avatar  me-3">
                                                    <img src="<?=viewImageAdmin($img[0]['img'])?>" alt="Avatar"
                                                        width="64" height="64">
                                                </div>
                                        ...
                                        <td><span class="badge badge-danger"><?=$id_product?></span></td>
