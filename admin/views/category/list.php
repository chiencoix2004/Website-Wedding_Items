                        ...
                        <div class="widget-content widget-content-area br-8">
                            <table id="ecommerce-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <?php extract($category); $hinhpath = "../../../uploads/" . $img;?>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="avatar  me-3">
                                                    <img src="<?=$hinhpath?>" alt="Avatar" width="64" height="64">
                                                </div>
                                                <div class="d-flex flex-column">
                                                    <span
                                                        class="text-truncate fw-bold"><?=$category["name_category"]?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?=$category["date_add"]?></td>
                                        <td></td>
                                        <td><span class="badge badge-success"><?=$category["id_category"]?></span></td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink3">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="index.php?act=editdm&id=<?=$category["id_category"]?>">Edit</a>
                                                    <a class="dropdown-item"
                                                        href="index.php?act=xoadm&id=<?=$category["id_category"]?>">Delete</a>
                                                </div>
                                            </div>
