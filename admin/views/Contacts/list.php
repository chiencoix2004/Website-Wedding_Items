                            ...
                            <table id="ecommerce-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Contact Date</th>
                                        <th>Status</th>
                                        <th class="no-content text-center">ID</th>
                                    </tr>
                                </thead>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <!-- <div class="avatar  me-3">
                                                    <img src="" alt="Avatar" width="64" height="64">
                                                </div> -->
                                                <div class="d-flex flex-column">
                                                    <span class="text-truncate fw-bold"><a
                                                            href="?act=ctlh&id=<?=$contact['id_contact']?>"><?=$contact['fullname']?></a></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?=$contact['phone_number']?></td>
                                        <td><?=$contact['contact_date']?></td>
                                        <td><?=status($contact['id_status'],$contact['name_status'])?></td>
