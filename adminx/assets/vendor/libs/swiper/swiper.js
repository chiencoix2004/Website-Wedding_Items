!(function (e, t) {
  ...
  return (function () {
            ...
            void 0 !== i &&
              ...
              (p(t[a]) && p(r[a])
                ? r[a].__swiper__
                  ...
                  : u(t[a], r[a])
                : !p(t[a]) && p(r[a])
                ? ((t[a] = {}), r[a].__swiper__ ? (t[a] = r[a]) : u(t[a], r[a]))
                : (t[a] = r[a]));
          }
        }
      }
    ...
    function oe(e, t, s) {
      ...
      return (
        r ||
          ((r = v("div", "swiper-slide-shadow" + (s ? `-${s}` : ""))),
          i.append(r)),
        r
      );
    }
    const de = [
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function d() {
          e.keyboard.enabled ||
            (i.addEventListener("keydown", o), (e.keyboard.enabled = !0));
        }
        function c() {
          e.keyboard.enabled &&
            (i.removeEventListener("keydown", o), (e.keyboard.enabled = !1));
        }
        ...
        function h(t) {
          return !(
            ...
            (e.params.mousewheel.thresholdTime &&
              d() - c < e.params.mousewheel.thresholdTime) ||
            (!(t.delta >= 6 && d() - c < 60) &&
              (t.direction < 0
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function p() {
          ...
          if (
            ...
            if (
              (s.dynamicBullets &&
                ((r = S(a[0], e.isHorizontal() ? "width" : "height", !0)),
                p.forEach((t) => {
          ...
          p.forEach((t, r) => {
            if (
              ("fraction" === s.type &&
                (t.querySelectorAll(J(s.currentClass)).forEach((e) => {
            ...
            "custom" === s.type && s.renderCustom
              ? ((t.innerHTML = s.renderCustom(e, i + 1, m)),
              ...
              "custom" !== t.type && (s.innerHTML = r || ""),
                "bullets" === t.type &&
                  e.pagination.bullets.push(
                    ...s.querySelectorAll(J(t.bulletClass))
                  );
            }),
        ...
        function T() {
          ...
          "string" == typeof a.el &&
            ...
            r &&
              ...
              n || ((n = v("div", e.params.scrollbar.dragClass)), r.append(n))),
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function y(t) {
          if (("mouse" === t.pointerType && p.splice(0, p.length), !b(t)))
            return;
          ...
          if (((r = !1), (n = !1), p.push(t), !(p.length < 2))) {
            if (((r = !0), (u.scaleStart = v()), !u.slideEl)) {
              ...
              if (
                ...
                (u.imageEl = a),
                (u.imageWrapEl = a
                  ? E(u.imageEl, `.${s.containerClass}`)[0]
                  : void 0),
                !u.imageWrapEl)
              )
            ...
            if (u.imageEl) {
              const [e, t] = (function () {
                ...
                return [
                  (p[0].pageX + (p[1].pageX - p[0].pageX) / 2 - e.x) / o,
                  (p[0].pageY + (p[1].pageY - p[0].pageY) / 2 - e.y) / o,
                ];
              })();
              (u.originX = e),
                (u.originY = t),
        ...
        function x(t) {
          ...
          i >= 0 && (p[i] = t),
            p.length < 2 ||
              ...
              (u.scaleMove = v()),
              u.imageEl &&
                ((a.scale = (u.scaleMove / u.scaleStart) * o),
                a.scale > u.maxRatio &&
                  (a.scale =
        ...
        function C(t) {
          ...
          if (!u.slideEl) {
            ...
            s &&
              ...
              (u.imageEl = s),
              (u.imageWrapEl = s
                ? E(u.imageEl, `.${a.containerClass}`)[0]
                : void 0);
          }
          ...
          1 === o && z && ((r = void 0), (n = void 0)),
            ...
            !t || (1 === o && z)
              ...
              : ((P = u.slideEl.offsetWidth),
                ...
                f < T && (f = T),
                f > C && (f = C)),
            z && 1 === s.scale && ((u.originX = 0), (u.originY = 0)),
        ...
        function P() {
          ...
          if (!u.slideEl) {
            e.params.virtual && e.params.virtual.enabled && e.virtual
              ? (u.slideEl = g(e.slidesEl, `.${e.params.slideActiveClass}`)[0])
              : (u.slideEl = e.slides[e.activeIndex]);
      ...
      function ({ swiper: e, extendParams: t, on: s }) {
        ...
        function m(t) {
          ...
          (e.pagination &&
            ...
            e.pagination &&
              a.matches(J(e.params.pagination.bulletClass)) &&
              a.click());
        }
        function h() {
          return (
                ...
                h() &&
                  e.pagination.bullets.forEach((s) => {
                    e.params.pagination.clickable &&
                      ...
                      s.matches(J(e.params.pagination.bulletActiveClass))
      ...
      function ({ swiper: e, extendParams: t, on: s }) {
        ...
        const a = (e, t, s) => {
          ...
          a ||
            ((a = v("div", "swiper-slide-shadow-" + (s ? "left" : "top"))),
            e.append(a)),
            i ||
              ((i = v(
                "div",
            ...
            c.shadow &&
              (p
                ...
                : ((m = t.querySelector(".swiper-cube-shadow")),
                  m || ((m = v("div", "swiper-cube-shadow")), t.append(m))));
            for (let e = 0; e < i.length; e += 1) {
              const t = i[e];
              let s = e;
              u &&
        ...
        re({
          ...
          setTransition: (t) => {
            ...
            s.forEach((e) => {
              ...
              le({ swiper: e, duration: t, transformElements: s });
          },
          recreateShadows: () => {
            e.params.flipEffect,
              e.slides.forEach((t) => {
