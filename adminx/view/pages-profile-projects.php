  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        <li class="nav-item"><a class="nav-link" href="pages-profile-user.html"><i class='ti ti-user-check ti-xs me-1'></i> Profile</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="pages-profile-connections.html"><i class='ti ti-link ti-xs me-1'></i> Connections</a></li>
      </ul>
    </div>
  </div>
  <!--/ Navbar pills -->
