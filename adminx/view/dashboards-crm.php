...
<ul class="p-0 m-0">
  <li class="d-flex mb-4 pb-1 align-items-center">
    <img src="view/img/icons/brands/chrome.png" alt="Chrome" height="28" class="me-3 rounded">
  ...
  <li class="d-flex mb-4 pb-1 align-items-center">
    <img src="view/img/icons/brands/safari.png" alt="Safari" height="28" class="me-3 rounded">
    <div class="d-flex w-100 align-items-center gap-2">
      <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
        <div>
  ...
  <li class="d-flex mb-4 pb-1 align-items-center">
    <img src="view/img/icons/brands/firefox.png" alt="Firefox" height="28" class="me-3 rounded">
    <div class="d-flex w-100 align-items-center gap-2">
      <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
        <div>
  ...
  <li class="d-flex mb-4 pb-1 align-items-center">
    <img src="view/img/icons/brands/opera.png" alt="Opera" height="28" class="me-3 rounded">
    <div class="d-flex w-100 align-items-center gap-2">
      <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
        <div>
  ...
  <li class="d-flex mb-4 pb-1 align-items-center">
    <img src="view/img/icons/brands/edge.png" alt="Edge" height="28" class="me-3 rounded">
    <div class="d-flex w-100 align-items-center gap-2">
      <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
        <div>
  ...
  <li class="d-flex align-items-center">
    <img src="view/img/icons/brands/brave.png" alt="Brave" height="28" class="me-3 rounded">
    <div class="d-flex w-100 align-items-center gap-2">
      <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
        <div>
...
<ul class="p-0 m-0">
  <li class="mb-3 pb-1 d-flex">
    <div class="d-flex w-50 align-items-center me-3">
      <img src="view/img/icons/brands/laravel-logo.png" alt="laravel-logo" class="me-3" width="35" />
      <div>
  ...
  <li class="mb-3 pb-1 d-flex">
    <div class="d-flex w-50 align-items-center me-3">
      <img src="view/img/icons/brands/figma-logo.png" alt="figma-logo" class="me-3" width="35" />
      <div>
  ...
  <li class="mb-3 pb-1 d-flex">
    <div class="d-flex w-50 align-items-center me-3">
      <img src="view/img/icons/brands/vue-logo.png" alt="vue-logo" class="me-3" width="35" />
      <div>
  ...
  <li class="mb-3 pb-1 d-flex">
    <div class="d-flex w-50 align-items-center me-3">
      <img src="view/img/icons/brands/react-logo.png" alt="react-logo" class="me-3" width="35" />
      <div>
  ...
  <li class="mb-3 pb-1 d-flex">
    <div class="d-flex w-50 align-items-center me-3">
      <img src="view/img/icons/brands/bootstrap-logo.png" alt="bootstrap-logo" class="me-3" width="35" />
      <div>
  ...
  <li class="d-flex">
    <div class="d-flex w-50 align-items-center me-3">
      <img src="view/img/icons/brands/sketch-logo.png" alt="sketch-logo" class="me-3" width="35" />
      <div>
  ...
  <tbody>
    <tr>
      <td>
        <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
            <img src="view/img/icons/payments/visa-img.png" alt="Visa" height="30">
          </div>
          <div class="d-flex flex-column">
    ...
    <tr>
      <td>
        <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
            <img src="view/img/icons/payments/master-card-img.png" alt="Visa" height="30">
          </div>
          <div class="d-flex flex-column">
    ...
    <tr>
      <td>
        <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
            <img src="view/img/icons/payments/american-express-img.png" alt="Visa" height="30">
          </div>
          <div class="d-flex flex-column">
    ...
    <div class="timeline-event">
      ...
      <div class="d-flex flex-wrap">
        <div class="avatar me-2">
          <img src="view/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
        </div>
        <div class="ms-1">
