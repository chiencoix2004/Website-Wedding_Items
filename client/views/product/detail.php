...
<?php foreach($productDetail as $item){extract($item);}  ?>
    ...
    <div class="main_content ">
        <div id="shopify-section-template-product"
            ...
            <div itemscope itemtype="http://schema.org/Product" class="product-scope container type_carousel">
                <meta itemprop="url"
                    content="https://theme481-wedding.myshopify.com/products/angel_formal_dress_womens_v-neck_lace_wedding_dress_for_bride" />
                <meta itemprop="image"
                    content="//theme481-wedding.myshopify.com/cdn/shop/products/angel_formal_dress_women_s_v-neck_lace_wedding_dress_for_bride_1_grande.png?v=1539259348" />
                <input type="hidden" name="" value="<?=$item['id_product']?>">
                <div class="row">
                    <?php $img =  getSanPhamAnhOne($item['id_product']); for ($i = 0; $i < count($img); $i++) : ?>
                    <div class="single_product__img col-sm-7">
                        <div id="gallery_thumbs-template-product"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="<?= viewImageAdmin($image['img']) ?>" alt="">
                                </div>
                                <?php endforeach; ?>
                        ...
                        <div id="gallery_big-template-product" class="gallery_big swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img id="primary_img_template-product" src=""
                                        alt="Angel Formal Dress Women's V-neck Lace Wedding Dress for Bride">
                                </div>
                    ...
                    <div class="single_product__info col-sm-5">
                        ...
                        <div class="single_product__details">
                            <form action="https://theme481-wedding.myshopify.com/cart/add" method="post"
                                ...
                                <div class="details_wrapper">
                                    ...
                                    <div class="price_and_quantity">
                                        <p class="single_product__price"><span
                                                id="single_product__price-template-product"><span
                                                    class="money">$<?=$item['price_product']?></span></span></p>
                                        ...
                                        <div class="single_product__quantity">
                                            ...
                                            <div class="quantity_box">
                                                ...
                                                <input id="single_product__quantity-template-product"
                                                    class="quantity_input" type="text" name="quantity" value="1">
                                    ...
                                    <div class="button_block">
                                        <button type="submit" name="add" class="btn"
                                            id="single_product__addtocart-template-product">Add to cart</button>
                            ...
                            <div class="product_notify">
                                <form method="post" action="https://theme481-wedding.myshopify.com/contact#contact_form"
                                    id="contact_form" accept-charset="UTF-8" class="notify_form"><input type="hidden"
                                    ...
                                    <input id="product_notify_input" type="hidden" name="contact[product]"
                                        value="https://theme481-wedding.myshopify.com/products/angel_formal_dress_womens_v-neck_lace_wedding_dress_for_bride">
                ...
                <form accept-charset="UTF-8" action="https://theme481-wedding.myshopify.com/contact" id="wishlist_form"
                    method="post">
